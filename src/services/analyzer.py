...
class AnalyzerService:
    ...
    async def get_text_complexity(raw_text: str) -> dict[str, float]:
        return {
            ...
            "dale_chall_readability_score_v2": textstat.dale_chall_readability_score_v2(raw_text),
            "dale_chall_readability_score": textstat.dale_chall_readability_score(raw_text),
